...
$pagination->page = $page;
$pagination->limit = 12;
$pagination->text_first = 'First'; //change the html for the first link here
$pagination->text_last = 'Last';//change the html for the last link here
$pagination->text_next = 'Next'; //change the html for the next link here
$pagination->text_prev = 'Prev'; //change the html for the previous link here
$pagination->style_links = 'links'; // change the html for div class here
$pagination->style_results = 'results'; // change the html for div class here
$pagination->text = $this->language->get('text_pagination'); //loaded from language english.php
$pagination->url = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
 $data['pagination'] = $pagination->render();
